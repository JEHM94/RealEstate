        ...
        <article class="blog-post">
            <div class="image">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" src="build/img/blog3.jpg"
                        alt="Imagen de entrada de Blog">
                </picture>
            </div> <!-- .image -->
        ...
        <article class="blog-post">
            <div class="image">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" src="build/img/blog4.jpg"
                        alt="Imagen de entrada de Blog">
                </picture>
            </div> <!-- .image -->
