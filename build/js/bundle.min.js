function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",responsiveNavigation)}function responsiveNavigation(){const e=document.querySelector(".navigation"),n=document.querySelector(".right");e.classList.toggle("show"),n.classList.toggle("show")}function darkMode(){document.querySelector(".dark-mode-btn").addEventListener("click",(function(){document.body.classList.toggle("dark")}))}
